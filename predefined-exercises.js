const PREDEFINED_EXERCISES = [
    ...
    { name: 'Incline Barbell Press', category: 'Push' },
    ...
    { name: 'Dumbbell Lateral Raise', category: 'Push' },
    ...
    { name: 'Overhead Triceps Extension (Dumbbell)', category: 'Push' },
    { name: 'Skull Crusher (Barbell)', category: 'Push' },
    ...
    { name: 'Crunch', category: 'Other' },
    { name: 'Leg Raise', category: 'Other' },
    { name: 'Russian Twist', category: 'Other' },
    { name: 'Cable Crunch', category: 'Other' },
    { name: 'Ab Roller', category: 'Other' },
];