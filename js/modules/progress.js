function createProgressModule() {
    let db, getState, calculateCurrentGoals;
    ...
    function renderProgressCharts() {
        ...
        caloriesChart = renderLineChart('calories-chart', caloriesChart, sortedFoodDates, calorieData, 'Total Calories', 'rgba(255, 99, 132, 1)', currentGoals.calories || 0);
        proteinChart = renderLineChart('protein-chart', proteinChart, sortedFoodDates, proteinData, 'Protein (g)', 'rgba(54, 162, 235, 1)', currentGoals.protein || 0);
